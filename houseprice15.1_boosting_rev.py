...
y3_hat=best_lasso_model.predict(train_x)
...
pred_y_lasso=best_lasso_model.predict(test_x)
...
# # csv 파일로 내보내기
sub_df.to_csv("./data/houseprice/sample_submission_stack2.csv", index=False)
