...
rf_model= RandomForestRegressor(random_state=20240911,n_estimators=100, max_features=None)

# 그리드 서치 for ElasticNet
param_grid={
    'alpha': [65.29999999999998], 
    'l1_ratio': [1.0]
}
...
# # csv 파일로 내보내기
sub_df.to_csv("./data/houseprice/sample_submission_.csv", index=False)
